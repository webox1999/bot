...
from handlers.start import user_phone_numbers, logger
from utils.delivery import calculate_delivery_date
...
async def show_orders(message: types.Message):
    ...
    try:
        ...
        response = requests.get(f"http://127.0.0.1:5000/get_client?phone={phone_number}")
